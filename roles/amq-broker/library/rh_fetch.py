...
requirements:
    ...
    - BeautifulSoup4
description:
    - Download artifacts from the RedHat Customer Portal with personal credentials
'''
...
def rh_fetch_module():
    ...
    if os.path.exists(target):
        ...
        try:
            ...
            if makedir_exception.errno == errno.EEXIST and os.path.isdir(fullpath):
                ...
                raise rh_fetch_module.fail_json(message=str(makedir_exception))
    ...
    try:
        ...
        rh_fetch_module.fail_json(message=str(ex))
